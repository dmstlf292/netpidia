	...
	<body>
		...
		<section class="tr-single-detail gray-bg">
			<div class="container">
				...
				<form class="book-form" method="post" action="productProc.jsp?flag=insert" enctype="multipart/form-data">
				<div class="row">
								...
								<div class="row">
									<div class="tr-single-box">
										<div class="tr-single-header">
											<h4><i class="fa fa-star-o"></i>Overview - Product Insert</h4>
										</div>
												...
												<div class="col-md-6 col-sm-6">
													<div class="listing-features">
														<div class="listing-features-box">
															...
															<div class="listing-features-detail">
																<input name="price" size="20"  class="form-control" placeholder="Enter Product Price..">
												...
												<div class="col-md-6 col-sm-6">
													<div class="listing-features">
														<div class="listing-features-box">
															...
															<div class="listing-features-detail">
																<input name="stock" size="10" class="form-control" placeholder="Enter Product Quantitiy..">
															</div>
														</div>
													</div>
												</div>
										...
										<div class="tr-single-body">
											<textarea rows="10" cols="95" name="detail"></textarea>
										</div>
									</div>
								</div>
							</div>
								...
								<form class="book-form" method="post" action="productProc.jsp?flag=insert" enctype="multipart/form-data">
									<div class="row">
										<div class="col-xs-12 mrg-top-15">	
											<input type="submit" value="Post" class="btn btn-danger ml-1 mt-2 full-width">
										</div>
									</div>
									<div class="row">
										<div class="col-xs-12 mrg-top-15">
