...
<jsp:useBean id="bean" class="netpidia.MyprofileBean"/>
...
<head>
    ...
    <title>Order List - Invoice</title>
														...
														<table class="table table-striped table-bordered">
															...
															<tbody>
																 <tr>
																	...
																	<td><a href="javascript:productDetail('<%=productNo%>')">
																		<%=pbean.getName()%></a>
																	</td>
																	...
																	<%
																		switch(order.getState()){
																			case "1": out.print("Accepting"); break;
																			case "2": out.print("Receipt"); break;
																			case "3": out.print("Confirmation of payment"); break;
																			case "4": out.print("Preparation for delivery"); break;
																			case "5": out.print("Shipping"); break;
																			case "6": out.print("Complete"); break;
																		}//---switch
																	%>
																	</td>
																</tr> 
