			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-2 col-md-2 col-sm-3 dashboard-bg">
					  ...
					  <form method="post" action="myprofileUpdateProc.jsp" enctype="multipart/form-data">
						<div class="col-lg-10 col-md-10 col-sm-9 col-lg-push-2 col-md-push-2 col-sm-push-3">
							<div class="row mrg-0 mrg-top-20">
								<div class="tr-single-box">
									<div class="tr-single-header">
										<h3 class="dashboard-title">My Profile Update</h3>
									</div>
										...
										<div class="row">
											<div class="col-md-4">
												<p>
												 ...
												 <p>
													<label>My Name</label>
													<input type="text" class="form-control"  name="name" value="<%=mbean.getName()%>" readonly>
												</p> 
												<p>
													Zipcode : <input type="button" value="Search" onClick="zipSearch()" class="btn btn-danger ml-1 mt-2">
													<input  class="form-control"  size="5"  name="zipcode" value="<%=fbean.getZipcode()%>" required>
												</p>
												<p>
													<label>Address</label>
													<input type="text" class="form-control" name="address" size="45" value="<%=fbean.getAddress()%>" required>
												</p>	
												<p>
													<label>About Me</label>
													<textarea  class="form-control" value="<%=fbean.getAboutme()%>" name="aboutme" required></textarea>
												</p> 	
											</div>
											<div class="col-md-4">
												...
												<p>
													<label>Phone</label>
													<input type="text"  class="form-control" value="<%=fbean.getPhone()%>" name="phone" required>
												</p>   
												<p>
												<label>I live in</label>
												   <input type="text"  class="form-control" value="<%=fbean.getLive()%>" name="live" required>
												</p>
												<p>
													<label>I speak</label>
													<input type="text"  class="form-control" value="<%=fbean.getSpeak()%>" name="speak" required>
												</p>
												<p>
													<label>Facebook Url</label>
													<input type="text"  class="form-control" value="<%=fbean.getFhp()%>" name="fhp">
												</p>
												 <p>
													<label>Instagram Url</label>
													<input type="text" class="form-control" value="<%=fbean.getIhp()%>" name="ihp">
												</p>		
											</div>		
											<div class="col-md-4">
